...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Feb 2024 pada 04.15
...
(1, 5, 1, '2024-02-20', '2024-02-20', 'Sudah di Kembalikan');
...
(1, 'admin', '$2y$10$bDZ3MGfQFjwQlnCMVOrJLOMJCykdrWczHpDexE6QY.5KthUxvjOI.', 'salma@gmail.com', 'admin', 'admin', 'Administrator'),
(4, 'peminjam1', '$2y$10$Y189BCBsiRJcc2SvV0CM/eUQFFUyQwoyIXLI1qisMal37VM4ylToq', 'peminjam1@gmail.com', 'peminjam1', 'samarang', 'Petugas'),
(5, 'peminjam', '$2y$10$ze6FAzGUyFXjoPu.Vizv3O7itk7zFdMPOQII70qkAhoSdcOtwYPJa', 'peminjam@gmail.com', 'sitisalma', 'samarang', 'Peminjam'),
(6, 'petugas1', '$2y$10$y9twSsDbfHI3Ur/YA9ix.uU00gxLeLzUglwbcc/D.5z0Q5F2wqaXm', 'petugas1@gmail.com', 'salwa', 'ps', 'Petugas');
